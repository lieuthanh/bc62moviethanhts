    ...
    return (
        <div className="container">
            <div className="row my-5">
                <div className="col-3">
                    <img src={data?.hinhAnh} className="w-100 rounded"
                        style={{ objectFit: "cover" }} height={400} alt={data?.tenPhim} />
                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <Row>
                                                        {item.lichChieuPhim.map((item, index) => {
                                                            return (
                                                                <Col sm={2}>
                                                                    <Button variant="primary" key={`lich-chieu-${index}`}>
                                                                        {dayjs(item.ngayChieuGioChieu).format("DD/MM hh:mm")}
                                                                    </Button>
                                                                </Col>
                                                            );
                                                        })}
